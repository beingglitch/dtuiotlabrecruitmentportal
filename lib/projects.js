...
export const PROJECTS = [
  // ───────────── Group A — Multi-disciplinary ─────────────
  {
    ...
    outcomes: ["Working prototype", "Defence-grade product"],
    commercial: "High. Defence procurement target.",
  ...
  },
  {
    ...
    outcomes: ["Research paper", "Defence-grade module"],
  ...
  },
  {
    ...
    duration: "12+ months",
    prerequisites: "Distributed across team",
    outcomes: ["Defence-grade product", "Research paper"],
